...
public class AccountsController {
    ...
    public ResponseEntity<String> getBuildInfo() throws TimeoutException {
        logger.debug("Get Build Info REST API called");
    ...
    public ResponseEntity<String> getBuildInfoFallback(Throwable ex) {
        logger.error("Get Build Info REST API failed: {}", ex.getMessage());
        return ResponseEntity
                .status(HttpStatus.OK)
                .body("0.9");
    }
    ...
    public ResponseEntity<String> getJavaVersionFallback(Throwable ex) {
        logger.error("Get Java Version REST API failed: {}", ex.getMessage());
        return ResponseEntity
                .status(HttpStatus.OK)
                .body("JAVA_HOME not found");
    }
